...
public class RusultAstigmatTest {
	...
	public RusultAstigmatTest(String nameLog,String ageLog,int scorea,int scoreb,int scorec){
                        this.score1 = scorea;
                        this.score2 = scoreb;
                        this.score3 = scorec;
		...
		score100 = Math.floor(score2*100.0/6.0);
		labelpic = new JLabel();
		pass = new ImageIcon("PassedAstig.jpg");
		failed = new ImageIcon("FailAstig.jpg");
		//////////////////////////////////////////
		frame = new JFrame();
		...
		click.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				MoreAdviceAstig Moread = new MoreAdviceAstig(loginname,loginage,score1,score2,score3);
