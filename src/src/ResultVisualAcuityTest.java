...
public class ResultVisualAcuityTest {
	...
	public ResultVisualAcuityTest(String nameLog,String ageLog,int scorea,int scoreb,int scorec){
                this.score1 = scorea;
                this.score2 = scoreb;
                this.score3 = scorec;
		...
		score100 = Math.floor(score3*100.0/6.0);
		labelpic = new JLabel();
		pass = new ImageIcon("PassVis.png");
		failed = new ImageIcon("FailVis.png");
		//////////////////////////////////////////
		frame = new JFrame();
		...
		click.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				MoreAdviceVisualAquity Moread = new MoreAdviceVisualAquity(loginname,loginage,score1,score2,score3);
